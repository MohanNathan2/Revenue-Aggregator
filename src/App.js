...
import './App.css';
import branch1 from "../src/api/branch1.json";
import branch2 from "../src/api/branch2.json";
import branch3 from "../src/api/branch3.json";
...
const RevenueAggregatorApp = () => {
  ...
  useEffect(() => {
    // Instead of fetching data from API, directly use the imported JSON data
